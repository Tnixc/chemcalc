  ...
  <div>
    ...
    >
      ...
      >
        ...
        />
        <button
          class="btn aspect-square hover:btn-error p-0 shadow-sm hover:shadow-lg"
    ...
    <div
      class="my-4 bg-base-200/50 p-4 rounded-xl ring-2 ring-neutral shadow-lg max-w-xs flex flex-col gap-2"
    >
      <button class="btn btn-accent shadow-md flex-grow" @click="calculate">
        Calculate
      </button>
      <button class="btn btn-error" @click="removeAll">Clear all</button>
    </div>
  </div>
</template>
