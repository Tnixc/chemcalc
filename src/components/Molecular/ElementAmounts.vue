...
export default {
  ...
  computed: {
    chemicalizeString() {
      function tokenize(inputStr: string): string[] {
      ...
      function convertStringsToInt(arr: string[]): (string | number)[] {
      ...
      function evaluateChemicalFormula(tokens: (string | number)[]): { [key: string]: number } {
